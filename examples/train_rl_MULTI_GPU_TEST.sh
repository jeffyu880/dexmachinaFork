...
declare -A PARAMS=(
    ...
    [experiment]="-exp allegro-ketchup100-mandicp3"
...
CMD=(
    torchrun --standalone --nnodes=1 --nproc_per_node=2 dexmachina/rl/train_rl_games.py
    # --vis
...
PRETTY_CMD="torchrun --standalone --nnodes=1 --nproc_per_node=2 dexmachina/rl/train_rl_games.py \\"
