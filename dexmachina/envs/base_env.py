...
class BaseEnv:
    ...
    def get_observations(self):
        ...
        for side in ['left', 'right']:
            self.robots[side].set_goal_state(
                wrist_pose    = self.reward_module.match_demo_state(f'wrist_pose_{side}', self.episode_length_buf),
                kpt_pos       = self.reward_module.match_demo_state(f'kpts_{side}', self.episode_length_buf),
